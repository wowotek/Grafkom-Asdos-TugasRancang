...
$(EXEC): control.o render.o camera.o structure.o main.o
	$(CC) $(CFLAGS) build/o/control.o build/o/render.o build/o/camera.o build/o/structure.o build/o/main.o $(CDEPS) -o build/bin/$(EXEC)
