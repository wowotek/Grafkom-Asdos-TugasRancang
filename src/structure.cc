...
Box(Coord3D pos, Coord3D size, CubeTexture * cubeTexture)
{
    ...
    glBegin(RENDER_MODE);
        ...
        glTexCoord2f(0.0, 1.0); glVertex3f(up3add(pos, sx, sy, 0));
        glTexCoord2f(0.0, 0.0); glVertex3f(up3add(pos, 0, sy, 0));
    glEnd();
    ...
    glBegin(RENDER_MODE);
        ...
        glTexCoord2f(0.0, 1.0); glVertex3f(up3add(pos, 0, sy, sz));
        glTexCoord2f(0.0, 0.0); glVertex3f(up3add(pos, 0, sy, 0));
    glEnd();
    ...
    glBegin(RENDER_MODE);
        ...
        glTexCoord2f(0.0, 1.0); glVertex3f(up3add(pos, sx, sy, sz));
        glTexCoord2f(0.0, 0.0); glVertex3f(up3add(pos, 0, sy, sz));
    glEnd();
    ...
    glBegin(RENDER_MODE);
        ...
        glTexCoord2f(0.0, 1.0); glVertex3f(up3add(pos, sx, 0, sz));
        glTexCoord2f(0.0, 0.0); glVertex3f(up3add(pos, sx, 0, 0));
    glEnd();
    ...
    glBegin(RENDER_MODE);
        ...
        glTexCoord2f(0.0, 1.0); glVertex3f(up3add(pos, 0, 0, sz));
        glTexCoord2f(0.0, 0.0); glVertex3f(up3add(pos, sx, 0, sz));
    glEnd();
    ...
    glBegin(RENDER_MODE);
        ...
        glTexCoord2f(1.0, 1.0); glVertex3f(up3add(pos, sx, sy, sz));
        glTexCoord2f(0.0, 1.0); glVertex3f(up3add(pos, sx, 0, sz));
        glTexCoord2f(0.0, 0.0); glVertex3f(up3add(pos, 0, 0, sz));
    glEnd();
}
